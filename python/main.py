...
class ResumeHandler(FileSystemEventHandler):
    def __init__(self, json_path, html_template_path):
...
class ResumeWatcher:
    def __init__(self, json_path, html_template_path):
        ...
        self.event_handler = ResumeHandler(json_path, html_template_path)
...
if __name__ == "__main__":
    json_path = os.path.abspath('resume.json')
    html_template_path = os.path.abspath('templates/template.html')
    output_html_path = os.path.abspath('output_resume.html')

    watcher = ResumeWatcher(json_path, html_template_path)
    watcher.start()
